...
public class UniversitasNusaPutra extends NilaiJavaMahasiswa {
    public UniversitasNusaPutra(String nama, String nim, int nilai) {
    ...
    public static void main(String[] args) {
        ...
        ArrayList <NilaiJavaMahasiswa> mhs = new ArrayList<>();
        ArrayList <NilaiJavaMahasiswa> lulus = new ArrayList<>();
        ArrayList <NilaiJavaMahasiswa> tidaklulus = new ArrayList<>();
        ...
        for (int i = 0; i < 4; i++) {
            ...
            mhs.add(new NilaiJavaMahasiswa(nama, nim, nilai));
            if((mhs.get(i).getGrade().compareTo("A") == 0) || (mhs.get(i).getGrade().compareTo("B") == 0) || (mhs.get(i).getGrade().compareTo("C") == 0)){
                lulus.add(new NilaiJavaMahasiswa(nama, nim, nilai));
            }
            else{
                tidaklulus.add(new NilaiJavaMahasiswa(nama, nim, nilai));
            }
            System.out.println("===================================");
        }
    ...
    public static void printMhs(ArrayList<NilaiJavaMahasiswa> mhs){
    ...
    public static void printNilai(ArrayList<NilaiJavaMahasiswa> mhs, String nilai){
    ...
    public static int jumlahGrade(ArrayList<NilaiJavaMahasiswa> mhs, String nilai){
        int jumlah = 0;
        for(int i = 0; i < mhs.size(); i++){
            if(mhs.get(i).getGrade().equals(nilai)){
                jumlah++;       
    ...
    public static float rataRata(ArrayList<NilaiJavaMahasiswa> mhs){
        System.out.println();
        int jumlah = 0;
        for(int i = 0; i < mhs.size(); i++){
